...
from .layers.log_uniform_sampler import LogUniformSampler, sample_logits
from .layers.proj_adaptive_softmax import ProjectedAdaptiveLogSoftmax
...
class MultiHeadAttn(nn.Module):
    def __init__(
        self, n_head, d_model, d_head, dropout, dropatt=0, pre_lnorm=False
    ):
