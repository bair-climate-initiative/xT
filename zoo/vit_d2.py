...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            input_dim (int): input dimension of the model for adjusting.
        """
        super().__init__()
...
class SimpleFeaturePyramid(nn.Module):
    ...
    def __init__(
        ...
        self.stages = []
        use_bias = norm == ""
        self.feature_info = [dict(num_chs=dim, reduction=strides[0])]
...
def vit_small_patch16(pretrained=False, img_size=1024, input_dim=2):
    # uses residual propagation instead of global (less memory)
    net = ViT(
        img_size=img_size,
        patch_size=16,
        embed_dim=768,
