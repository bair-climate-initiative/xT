...
from timm.models.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_, ClassifierHead
...
class ReversibleSwinTransformerV2(nn.Module):
    ...
    def __init__(
        ...
        self.feature_info += [dict(num_chs=embed_dim[0], reduction=2, module=f'patch_embed')]
        ...
        for i in range(self.num_layers):
            ...
            self.feature_info += [dict(num_chs=out_dim * 2, reduction=4 * scale, module=f'layers.{i}')]
