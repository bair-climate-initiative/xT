CUDA_VISIBLE_DEVICES=0,1 WANDB_API_KEY=553070c5ef0d454bcb1e91afaabf2359ef69f4a0 singularity exec --nv --bind $WORKDIR:$WORKDIR \
  ...
  python3 -m torch.distributed.launch\
        ...
        --val-dir $HOME/output-exps_512_swin_l_bs_4_lr_3e-4_ep120-$ID  \
        --output-dir $HOME/output-exps_512_swin_l_bs_4_lr_3e-4_ep120-$ID \
        --folds-csv meta/folds.csv \
        --prefix val_only_  \
        --fold 77    \
        --freeze-epochs 0 \
        --fp16 --name exps_512_swin_l_bs_4_lr_3e-4_ep120 \
        --crop_size 512 \
        --crop_size_val 512 \
        --overlap_val 10 \
        --positive_ratio 0.8 \
